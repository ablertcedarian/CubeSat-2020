...
def main():
    ...
    mag_scale_calibration = [scale_x, scale_y, scale_z]
    mag_calibration = [offset_x, offset_y, offset_z]
    
    print(
        "Final Magnetometer Calibration Offset: X: {0:8.2f}, Y:{1:8.2f}, Z:{2:8.2f} uT".format(
            offset_x, offset_y, offset_z
        )
    )
    print(
        "Final Magnetometer Calibration Scale: X: {0:8.2f}, Y:{1:8.2f}, Z:{2:8.2f} uT".format(
    ...
    print("")
    print("------------------------------------------------------------------------")
    print("Final Magnetometer Calibration Offset: ", mag_calibration)
    print("Final Magnetometer Calibration Scale: ", mag_scale_calibration)
